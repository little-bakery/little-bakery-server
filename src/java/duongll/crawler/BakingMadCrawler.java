        ...
        try {
            ...
            while (xPath.evaluate("//li[@class='pagination__next is-disabled']", document).isEmpty()
                ...
                for (int i = 0; i < cakeRecipesList.getLength(); i++) {
                    ...
                    String cakeXML = XSLTA.applyStylesheet("F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\xslt\\cake-baking-mad.xsl", cakeLinkHTMLSource);
                    ...
                    String ingredientXML = XSLTA.applyStylesheet("F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\xslt\\ingredient-baking-mad.xsl", cakeLinkHTMLSource);
                    Ingredients ingredientList = XMLUtils.unmarshal(ingredientXML,
                            "F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\schema\\ingredient.xsd", Ingredients.class
                    );
                    ...
                    String preparationXML = XSLTA.applyStylesheet("F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\xslt\\preparation-baking-mad.xsl", cakeLinkHTMLSource);
                    CakePreparations cakePreparationsList = XMLUtils.unmarshal(preparationXML,
                            "F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\schema\\preparation.xsd", CakePreparations.class);
                    for (CakePreparation preparation : cakePreparationsList.getCakepreparations()) {
                        preparation.setCakeid(cakeResult);
                        preparation.setContentprepare(ConverterUtils.convertQuantity(preparation.getContentprepare()));
                        cakePreparationClient.createCakePreparation_XML(preparation, CakePreparation.class);
                    }
                    String materialXML = XSLTA.applyStylesheet("F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\xslt\\material-baking-mad.xsl", cakeLinkHTMLSource);
                    Materials materialList = XMLUtils.unmarshal(materialXML,
                            "F:\\Semester 8\\PRX\\Little_Bakery_Server\\src\\java\\duongll\\schema\\material.xsd", Materials.class);
