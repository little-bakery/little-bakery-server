...
public class CategoryFacadeREST extends AbstractFacade<Category> {
    ...
    public Category findByName(@QueryParam("name") String categoryName) {
        TypedQuery query = em.createNamedQuery("Category.findByName", Category.class);
